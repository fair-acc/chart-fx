...
public class ColorChooserSample extends Application {
    ...
    public void start(final Stage stage) {
        ...
        utilityStage.setTitle("Color Chooser");
        ...
        colorChooser.chosenColorProperty().addListener((observableValue, oldColor, newColor) -> System.out.println("Chose: " + colorChooser.getChosenColorName() + " " + colorChooser.getChosenColor()));
    }
     ...
     */
    static class ColorChooser extends VBox {
         ...
         */
        private final DoubleProperty prefTileSize = new SimpleDoubleProperty(MIN_TILE_SIZE);
