...
import io.fair_acc.financial.samples.*;
...
import io.fair_acc.chartfx.utils.PeriodicScreenCapture;
import io.fair_acc.misc.samples.LimitsSample;
...
public class RunChartSamples extends Application {
    ...
    public void start(final Stage primaryStage) {
        ...
        // buttons.getChildren().add(new MyButton("WriteDataSetToFileSample", new WriteDataSetToFileSample())); // removed because it depends on serialiser
