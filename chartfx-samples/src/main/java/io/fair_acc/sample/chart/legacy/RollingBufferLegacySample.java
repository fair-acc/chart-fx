 ...
 */
@Deprecated
public class RollingBufferLegacySample extends ChartSample {
    ...
    public String getControlStylesheetURL() {
        return Objects.requireNonNull(RollingBufferLegacySample.class.getResource("RollingBufferLegacy.css")).toExternalForm();
    }
