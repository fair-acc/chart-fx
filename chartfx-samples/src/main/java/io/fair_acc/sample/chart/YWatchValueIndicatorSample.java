 ...
 * @author akrimm
 */
public class YWatchValueIndicatorSample extends ChartSample {
    ...
    public String getControlStylesheetURL() {
        return Objects.requireNonNull(YWatchValueIndicatorSample.class.getResource("YWatchValueIndicatorSample.css"), "stylesheet not found").toExternalForm();
    }
