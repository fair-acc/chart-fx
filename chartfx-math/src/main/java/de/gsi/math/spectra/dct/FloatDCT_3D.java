...
/**
 * Computes 3D Discrete Cosine Transform (DCT) of single precision data. The sizes of all three dimensions can be
...
public class FloatDCT_3D {
     ...
     */
    public FloatDCT_3D(final int slices, final int rows, final int columns) {
