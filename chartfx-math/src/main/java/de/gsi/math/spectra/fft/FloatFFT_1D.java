...
public strictfp class FloatFFT_1D {
    ...
    private static final float PI = (float) TMath.Pi();
    private static final float TWO_PI = (float) TMath.TwoPi();
    private final int n;
    ...
    /*---------------------------------------------------------
      ...
      --------------------------------------------------------*/
    void cfftf(final float a[], final int offa, final int isign) {
        int idot;
        int l1, l2;
    ...
    private int cfttree(final int n, final int j, final int k, final float[] a, final int offa, final int nw,
            final float[] w) {
        int i, isplt, m;
        final int idx1 = offa - n;
        if ((k & 3) != 0) {
    ...
    private void cftxc020(final float[] a, final int offa) {
        float x0r, x0i;
        x0r = a[offa] - a[offa + 2];
        x0i = a[offa + 1] + a[offa + 3];
        a[offa] += a[offa + 2];
     ...
     * float values in sequence: the real and imaginary part, i.e. the size of the input array must be greater or equal
     ...
     */
    public void complexForward(final float[] a, final int offa) {
        if (n == 1) {
            return;
        }
        switch (plan) {
     ...
     * @param scale if true then scaling is performed
     */
    public void complexInverse(final float[] a, final int offa, final boolean scale) {
        if (n == 1) {
            return;
        }
        switch (plan) {
        ...
        if (ido != 2) {
            for (int k = 0; k < l1; ++k) {
                ...
                for (i = 2; i < ido; i += 2) {
                    ...
                    final float i1i = in[iidx1];
                    final float i1r = in[iidx1 - 1];
                    final float i2i = in[iidx2];
                    final float i2r = in[iidx2 - 1];
    ...
    void radb4(final int ido, final int l1, final float in[], final int in_off, final float out[], final int out_off,
        ...
        for (int k = 0; k < l1; k++) {
            ...
            final float i1r = in[in_off + idx2];
            final float i2r = in[in_off + idx7];
            final float i3r = in[in_off + ido - 1 + idx8];
            final float i4r = in[in_off + ido - 1 + idx6];
        ...
        for (int k = 0; k < l1; k++) {
            ...
            final float i1r = in[idx9 - 1 + idx2];
            final float i2r = in[idx9 - 1 + idx7];
            final float i3r = in[in_off + idx6];
            final float i4r = in[in_off + idx8];
     ...
     * @param offa index of the first element in array <code>a</code>
     */
    public void realForward(final float[] a, final int offa) {
        if (n == 1) {
            return;
        }
     ...
     * @param scale if true then scaling is performed
     */
    public void realInverse(final float[] a, final int offa, final boolean scale) {
        if (n == 1) {
            return;
        }
        switch (plan) {
    ...
    protected void realInverse2(final float[] a, final int offa, final boolean scale) {
        if (n == 1) {
            return;
        }
        switch (plan) {
     ...
     * @param scale if true then scaling is performed
     */
    public void realInverseFull(final float[] a, final int offa, final boolean scale) {
        final int twon = 2 * n;
        switch (plan) {
        case SPLIT_RADIX:
    ...
    private void rftbsub(final int n, final float[] a, final int offa, final int nc, final float[] c,
            final int startc) {
        int k, kk, ks, m;
    ...
    private void rftfsub(final int n, final float[] a, final int offa, final int nc, final float[] c,
            final int startc) {
        int k, kk, ks, m;
        float wkr, wki, xr, xi, yr, yi;
        int idx1, idx2;
    ...
    private void scale(final float m, final float[] a, final int offa, final boolean complex) {
