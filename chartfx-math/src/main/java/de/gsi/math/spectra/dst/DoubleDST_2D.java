...
/**
 * Computes 2D Discrete Sine Transform (DST) of double precision data. The sizes of both dimensions can be arbitrary
...
public class DoubleDST_2D {
     ...
     */
    public DoubleDST_2D(final int rows, final int columns) {
        if (rows <= 1 || columns <= 1) {
