...
/**
 * Computes 3D Discrete Sine Transform (DST) of single precision data. The sizes of all three dimensions can be
...
public class FloatDST_3D {
    ...
    private final FloatDST_1D dstSlices;
     ...
     */
    public FloatDST_3D(final int slices, final int rows, final int columns) {
