...
/**
 * Computes 3D Discrete Hartley Transform (DHT) of real, double precision data. The sizes of all three dimensions can be
...
public class DoubleDHT_3D {
    ...
    private final DoubleDHT_1D dhtSlices;
     ...
     */
    public DoubleDHT_3D(final int slices, final int rows, final int columns) {
