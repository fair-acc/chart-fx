...
public class TestDataClass {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!Objects.equals(string1, other.string1)) { //NOSONAR //NOPMD null-compatible String check
            LOGGER.atError().addArgument("string1").addArgument(this.string1).addArgument(other.string1) //
                    .log("field '{}' does not match '{}' vs '{}'");
            returnState = false;
        }
        if (!isCmwCompatibilityMode()) {
            if (!Objects.equals(string2, other.string2)) { //NOSONAR //NOPMD null-compatible String check
