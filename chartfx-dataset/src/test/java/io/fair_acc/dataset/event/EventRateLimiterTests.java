...
public class EventRateLimiterTests {
    ...
    public void constructorTests() {
        ...
        assertDoesNotThrow(() -> new EventRateLimiter(evt -> { /* do nothing */ }, MAX_UPDATE_PERIOD, EventRateLimiter.UpdateStrategy.INSTANTANEOUS_RATE));
    }
    ...
    public void rateLimiterTests() {
        ...
        evtSource.addListener(new EventRateLimiter(evt -> updateCount3.incrementAndGet(), MAX_UPDATE_PERIOD, EventRateLimiter.UpdateStrategy.INSTANTANEOUS_RATE));

        final EventRateLimiter rateLimitAvg = new EventRateLimiter(evt -> updateCount4.incrementAndGet(), MAX_UPDATE_PERIOD, EventRateLimiter.UpdateStrategy.AVERAGE_RATE);
