...
class MultiDimDoubleDataSetTests {
    ...
    public void testCopyConstructors() {
        ...
        MultiDimDoubleDataSet dataset3 = new MultiDimDoubleDataSet("Test Dataset",
                new double[][] { { 1, 2, 3, 4 }, { 2, 4, 6, 8 }, { 3, 3, 6, 8 }, { 1, 5, 7, 1 } }, 4, true);
    ...
    public void testInterpolation() {
        ...
        assertEquals(Double.NaN, dataset.getValue(1, 3.5));
        assertEquals(Double.NaN, dataset.getValue(1, 2.5));
