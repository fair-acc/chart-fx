...
public class Histogram2 extends AbstractHistogram implements Histogram2D {
     ...
     * (non-Javadoc)
     *
     * @see io.fair_acc.dataset.Histogram2D#fill(double, double)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see io.fair_acc.dataset.Histogram2D#fill(double, double, double)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see io.fair_acc.dataset.Histogram2D#findFirstBinAbove(double, double)
     */
    @Override
