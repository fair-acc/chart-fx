...
public final class RandomDataGenerator {
    ...
    private static final double xMax = 100.0; // Assuming that xMin is zero.
    private static final double peak = 10.0;
    private static final double back = RandomDataGenerator.peak / 10.0;
    private static final double yMax = (RandomDataGenerator.peak + RandomDataGenerator.back) * 1.1;
    private static final double sarurationLevel = RandomDataGenerator.peak * 1.5;
