...
public enum DataType {
    // @formatter:off
    // primitive types
    BOOL                     (0     ,"bool"           ,"boolean",           1, Boolean.class, true),
    BYTE                     (1     ,"byte"           ,"byte",              1, Byte.class, true),
    SHORT                    (2     ,"short"          ,"short",             2, Short.class, true),
    INT                      (3     ,"int"            ,"int",               4, Integer.class, true),
    LONG                     (4     ,"long"           ,"long",              8, Long.class, true),
    FLOAT                    (5     ,"float"          ,"float",             4, Float.class, true),
    DOUBLE                   (6     ,"double"         ,"double",            8, Double.class, true),
    CHAR                     (7     ,"char"           ,"char",              2, Character.class, true),
    STRING                   (8     ,"string"         ,"string",            1, String.class, true),

    // array of primitive types
    BOOL_ARRAY               (100   ,"bool_array"     ,"[Z",                1, Boolean[].class, false),
    BYTE_ARRAY               (101   ,"byte_array"     ,"[B",                1, Byte[].class, false),
    SHORT_ARRAY              (102   ,"short_array"    ,"[S",                2, Short[].class, false),
    INT_ARRAY                (103   ,"int_array"      ,"[I",                4, Integer[].class, false),
    LONG_ARRAY               (104   ,"long_array"     ,"[J",                8, Long[].class, false),
    FLOAT_ARRAY              (105   ,"float_array"    ,"[F",                4, Float[].class, false),
    DOUBLE_ARRAY             (106   ,"double_array"   ,"[D",                8, Double[].class, false),
    CHAR_ARRAY               (107   ,"char_array"     ,"[C",                2, Character[].class, true),
    STRING_ARRAY             (108   ,"string_array"   ,"[java.lang.String", 1, String[].class, false),
    ...
    DataType(final int byteValue, final String stringValue, final String javaName, final long primitiveSize, Class<?> classType,
            boolean isScalar) {
