 ...
 * * start marker:  [ field name:String  ] + [ 1 byte - uniqueType (0x00) ][ 1 byte - uniqueType (0x00) ]
 ...
 * * end marker:    [ field name: String ][1 byte - uniqueType (0xFE) ][ 1 byte - uniqueType (0xFE) ]
 * 
 * N.B. nesting is achieved via:
