...
public interface DataSetError extends DataSet {
    ...
    /**
     * Returns the negative error along the X axis of a point specified by the <code>index</code>. Please note that
     * errors are assumed to be always positive!
     *
    ...
    /**
     * Returns the negative error along the X axis for all available data points. Please note that errors are assumed to
     * be always positive!
     *
    ...
    /**
     * Returns the positive error along the X axis of a point specified by the <code>index</code>. Please note that
     * errors are assumed to be always positive!
     *
    ...
    /**
     * Returns the positive error along the X axis for all available data points. Please note that errors are assumed to
     * be always positive!
     *
    ...
    /**
     * Returns the negative error along the Y axis of a point specified by the <code>index</code>. Please note that
     * errors are assumed to be always positive!
     *
    ...
    /**
     * Returns the negative error along the Y axis for all available data points. Please note that errors are assumed to
     * be always positive!
     *
    ...
    /**
     * Returns the positive error along the Y axis of a point specified by the <code>index</code>. Please note that
     * errors are assumed to be always positive!
     *
    ...
    /**
     * Returns the positive error along the y axis for all available data points. Please note that errors are assumed to
     * be always positive!
     *
    ...
    /**
     * Returns the negative error along the X axis of a point specified by the <code>x</code> coordinate. Please note
    ...
    default double getXErrorNegative(final double x) {
        ...
        final double de2 = getXErrorNegative(index2);
        ...
        return de1 + (de2 - de1) * (x - x1) / (x2 - x1);
    }

    /**
     * Returns the positive error along the X axis of a point specified by the <code>x</code> coordinate. Please note
     * that errors are assumed to be always positive!
     *
     * @param x horizontal x coordinate
     * @return positive X error
    ...
    default double getXErrorPositive(final double x) {
        ...
        final double de2 = getXErrorPositive(index2);
        if (Double.isNaN(y1) || Double.isNaN(y2)) {
            // case where the function has a gap (y-coordinate equals to NaN
            return Double.NaN;
        }
    ...
    /**
     * Returns the negative error along the Y axis of a point specified by the <code>x</code> coordinate. Please note
     * that errors are assumed to be always positive!
     *
     * @param x horizontal x coordinate
     * @return negative Y error
    ...
    default double getYErrorNegative(final double x) {
        ...
        final double de2 = getYErrorNegative(index2);
        if (Double.isNaN(y1) || Double.isNaN(y2)) {
            // case where the function has a gap (y-coordinate equals to NaN
            return Double.NaN;
        }
    ...
    /**
     * Returns the positive error along the Y axis of a point specified by the <code>x</code> coordinate. Please note
     * that errors are assumed to be always positive!
     *
     * @param x horizontal x coordinate.
     * @return positive Y error
    ...
    default double getYErrorPositive(final double x) {
        ...
        final double de2 = getYErrorPositive(index2);
        if (Double.isNaN(y1) || Double.isNaN(y2)) {
            // case where the function has a gap (y-coordinate equals to NaN
            return Double.NaN;
        }
