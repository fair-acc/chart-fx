...
/**
 * A {@link java.util.NavigableSet} implementation based on a
 * {@link IndexedTreeMap}. The elements are ordered using their
 * {@linkplain Comparable natural ordering}, or by a
 * {@link java.util.Comparator} provided at set creation time, depending on
 ...
 * of the {@code equals} operation, but a {@code IndexedTreeSet} instance
 ...
 * to obey the general contract of the {@code Set} interface.
 * </p>
 * <p>
 ...
 * using the {@link java.util.Collections#synchronizedSortedSet
 ...
 * the iterator will throw a {@link java.util.ConcurrentModificationException}.
...
public class IndexedTreeSet<E> extends java.util.AbstractSet<E>
    ...
    /**
     * Returns a shallow copy of this {@code IndexedTreeSet} instance. (The
    ...
    /**
     * Save the state of the {@code IndexedTreeSet} instance to a stream (that
     * is, serialize it).
     * @param s output stream
