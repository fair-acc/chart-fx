 ...
 * @author braeun
 */
public class AveragingDataSet extends AbstractDataSet<AveragingDataSet> implements DataSetError {
    ...
    public double getErrorNegative(int dimIndex, int index) {
        return dataset.getErrorNegative(dimIndex, index);
    }

    @Override
    public double getErrorPositive(int dimIndex, int index) {
        return dataset.getErrorPositive(dimIndex, index);
    }

    @Override
    public ErrorType getErrorType(int dimIndex) {
        return dataset.getErrorType(dimIndex);
    }
}
