...
public class FootprintRenderedAPIDummyAdapter implements FootprintRenderer.IFootprintRenderedAPI {
    ...
    public NbColumnColorGroup getColumnColorGroup(IOhlcvItem ohlcvItem) {
        if (idx == 0 || idx == 1) {
            Font[] fonts = footprintAttrs.getAttribute(FootprintRendererAttributes.BID_ASK_VOLUME_FONTS);
            Color[][] colors = footprintAttrs.getAttribute(FootprintRendererAttributes.COLUMN_COLOR_GROUP_SETTINGS);
            NbColumnColorGroup nbColumnColorGroup = new NbColumnColorGroup();
            nbColumnColorGroup.fontColorMap.put(ohlcvItem.getOpen(), new NbColumnColorGroup.FontColor(fonts[1], colors[1][3], fonts[1], colors[0][3]));
            nbColumnColorGroup.fontColorMap.put(ohlcvItem.getHigh(), new NbColumnColorGroup.FontColor(fonts[2], colors[1][2], fonts[2], colors[0][2]));
            nbColumnColorGroup.fontColorMap.put(ohlcvItem.getLow(), new NbColumnColorGroup.FontColor(fonts[1], colors[1][1], fonts[2], colors[0][1]));
            nbColumnColorGroup.fontColorMap.put(ohlcvItem.getClose(), new NbColumnColorGroup.FontColor(fonts[1], colors[1][0], fonts[2], colors[0][0]));
