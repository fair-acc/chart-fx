...
class ContourDataSetCache {
    ...
    protected static WritableImage convertDataArrayToImage(final double[] inputData, final int dataWidth, final int dataHeight,
        ...
        final WritableImage image = WritableImageCache.getInstance().getImage(dataWidth, dataHeight);
