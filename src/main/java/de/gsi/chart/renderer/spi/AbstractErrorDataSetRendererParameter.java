 ...
 * @param <X> generic object type for x-Axis data type
 * @param <Y> generic object type for y-Axis data type
 */
public abstract class AbstractErrorDataSetRendererParameter<R extends AbstractErrorDataSetRendererParameter<R>>
    ...
    /**
     * sets the data reduction algorithm: possibly implementations are {@link DefaultDataReducer} (default)
     * {@link MaxDataReducer} (a simple down-sampling algorithm, returning fixed number of max. 1000 points)
     * {@link RamanDouglasPeukerDataReducer} {@link DouglasPeukerDataReducer}
