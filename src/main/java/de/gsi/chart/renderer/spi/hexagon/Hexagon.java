...
public class Hexagon extends Polygon {
    ...
    private double[] calculatePolygonPoints() {
        ...
        // }
        // new look-up table-based implementation
        for (int i = 0; i < 6; i++) {
     ...
     */
    public ArrayList<Hexagon> getHexagonsOnRingEdge(final int radius) {
        checkMap();
     ...
     */
    public ArrayList<Hexagon> getHexagonsInRingArea(final int radius) {
        checkMap();
    ...
    private void checkMap() {
        if (map == null) {
            throw new RuntimeException("Hexagon must be added to a HexagonMap before this operation. See addHexagon()");
        }
    }
     ...
     */
    public ArrayList<Hexagon> getPathTo(final Hexagon destination, final IPathInfoSupplier pathInfoSupplier)
     ...
     * @throws NoPathFoundException if there exists no path between start and the goal
     */
    public ArrayList<Hexagon> getPathTo(final Hexagon destination) throws NoPathFoundException {
        checkMap();
     ...
     */
    public ArrayList<Hexagon> getLine(final Hexagon origin, final Hexagon destination) {
        checkMap();
     ...
     */
    public ArrayList<Hexagon> getVisibleHexes(final int visibleRange) {
        checkMap();
