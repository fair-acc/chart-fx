...
import de.gsi.chart.data.testdata.spi.RandomStepFunction;
import de.gsi.chart.data.testdata.spi.RandomWalkFunction;
import de.gsi.chart.data.testdata.spi.SincFunction;
import de.gsi.chart.data.testdata.spi.SineFunction;
import de.gsi.chart.data.testdata.spi.SingleOutlierFunction;
...
public class ErrorDataSetRendererStylingSample extends Application {
    ...
    public void start(final Stage primaryStage) {
        ProcessingProfiler.verboseOutputProperty().set(false);
