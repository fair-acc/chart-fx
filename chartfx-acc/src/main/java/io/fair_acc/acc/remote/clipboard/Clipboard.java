package io.fair_acc.acc.remote.clipboard;

import static io.fair_acc.acc.remote.BasicRestRoles.ANYONE;
import static io.fair_acc.acc.remote.RestServer.prefixPath;
...
import io.fair_acc.acc.remote.RestCommonThreadPool;
import io.fair_acc.acc.remote.RestServer;
import io.fair_acc.acc.remote.util.CombinedHandler;
...
import io.fair_acc.dataset.remote.DataContainer;
...
import io.fair_acc.dataset.utils.Cache.CacheBuilder;
import io.fair_acc.dataset.utils.GenericsHelper;
 ...
 * another custom {@link io.fair_acc.acc.remote.user.RestUserHandler }
 * implementation.
 * 
 * @author rstein
 *
